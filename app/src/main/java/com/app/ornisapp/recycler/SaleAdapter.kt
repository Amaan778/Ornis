...
class SaleAdapter(private val list: List<Pair<String, Sale>>) :
...
//        val saleDate: TextView = itemView.findViewById(R.id.rec_date) // Make sure this exists in XML
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.salesrecy, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.paymentMode.text = current.paymentMode
    }
}
